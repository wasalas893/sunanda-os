;sunanda --- The sunanda Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE SUNANDAOS_VER '1.0.0'	 ;OS version number
	%DEFINE SUNANDAOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to SUNANDA OS****************************', 0
	os_version_msg		db 'Version ', SUNANDAOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', SUNANDAOS_VER, 0

	dialog_string_1		db 'Welcome to sunanda Operating System', 0
